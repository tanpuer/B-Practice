package com.example.cw.b_practice.vLayout;
...
/**
 * Created by cw on 2017/6/16.
 */

public class VLayoutActivity extends RxBaseActivity implements MyItemClickListener{
    ...
    protected int getLayoutId() {
        return R.layout.activity_v_layout;
    }

    @Override
    protected void initViews(Bundle savedInstanceState) {
        //创建VirtualLayoutManager对象，同时会创建LayoutHelperFinder,用来后续的LayoutHelper查找
...
//        }
     ...
     * 设置组件回收池
     */
    private void setRecyclePool(){
        RecyclerView.RecycledViewPool viewPool = new RecyclerView.RecycledViewPool();
        mRecyclerview.setRecycledViewPool(viewPool);
        viewPool.setMaxRecycledViews(0, 10);
        //如果页面有多种type，需要为每一种类型调整复用池的大小
    }
